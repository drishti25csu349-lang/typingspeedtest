...
int main() {
    ...
    if (choice == 1) {
        ...
        switch (level) {
            case 1:
                if (wc == 1) sample = easy25; else if (wc == 2) sample = easy50; else sample = easy100; break;
            case 2:
                if (wc == 1) sample = medium25; else if (wc == 2) sample = medium50; else sample = medium100; break;
            case 3:
                if (wc == 1) sample = hard25; else if (wc == 2) sample = hard50; else sample = hard100; break;
        }
    } else {
    ...
    printf("Accuracy         : %.2f%%\n", accuracy);
    printf("===========================\n");
    printf("Timer up! Keep practicing and improving.\n");
